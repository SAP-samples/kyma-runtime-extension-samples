...
5. View the details of the account that was registered in the **Identity Access** screen of the SAP Customer Data Cloud console. It can be observed that the address of the user has been cleansed.

		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Lionel Fridgy Webapp",
									"targetURL": "#webapplionelfridgywebapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"webapplionelfridgywebapp-display": {
								"semanticObject": "webapplionelfridgywebapp",
								"action": "display",
								"description": "A visualization provided by Lionel Fridgy",
								"title": "Lionel Fridgy Webapp",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=webapp.lionelfridgy.webapp",
									"url": sap.ui.require.toUrl("webapp/lionelfridgy/webapp")
								}
							}
						}
					}
